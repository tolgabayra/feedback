...
class Business(db.Model):
    ...
    business_type_id = db.Column(
        db.Integer, db.ForeignKey("business_types.id"), nullable=False
    )
...
class FeedbackType(db.Model):
    ...
    feedbacks = db.relationship(
        "Feedback", backref="feedback_type_feedbacks", lazy=True
    )
...
class District(db.Model):
    ...
    def to_dict(self):
        return {"id": self.id, "name": self.name, "city_id": self.city_id}
