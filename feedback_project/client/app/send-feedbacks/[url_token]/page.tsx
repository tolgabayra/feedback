        ...
        <div>
            {
                ...
                <div>
                    <section className="bg-gradient-to-b from-gray-100 to-white">
                        {
                            isSend ?
                                <Notification className='text-center' color="green" title="Gönderildi">
                                    <p className='text-xl'>
                                        Teşekkür ederiz
                                            ...
                                            <form onSubmit={handleSendFeedback}>
                                                ...
                                                <div className="flex flex-wrap -mx-3 mb-4">
                                                    <div className="w-full px-3">
                                                        ...
                                                        <textarea onChange={(e) => setContent(e.target.value)} id="content" className="form-input w-full text-gray-800" placeholder="Ne söylemek istiyorsunuz ?" required />
                                                    </div>
                                                </div>
